              ...
              >
                ...
                >
                  ...
                  {tab.badge !== undefined && tab.badge > 0 && (
                    <span className="absolute -top-1.5 right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-rose-500 text-white text-[10px] font-black flex items-center justify-center shadow">
